...
\begin{itemize}
    \item Derivatives formulas:: product, quotient, chain rule, $x^n, sinx, cosx, tanx, a^x, lnx$ 
    ...
    \item Integration $x^n$, Substitution Rule, Integration By Parts, Fubini's Rule
\end{itemize}
